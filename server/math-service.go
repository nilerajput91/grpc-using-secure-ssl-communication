...
func (m *myMathService) Add(ctx context.Context, in *model.MathRequest) (*model.MathResponse, error) {
	...
	if in == nil {
		return nil, fmt.Errorf("Add called with invaild parameter value nil")
	}

	if in.GetOperand2() == 0 {
		return nil, fmt.Errorf("Add called with invalid paramter operand2 == 0")
	}
...
func (m *myMathService) Sub(ctx context.Context, in *model.MathRequest) (*model.MathResponse, error) {
	...
	if in == nil {
		return nil, fmt.Errorf("Sub called with invaild parameter value nil")
	}
	if in.GetOperand2() == 0 {
		return nil, fmt.Errorf("Sub called with invalid paramter operand2 == 0")
	}
...
func (m *myMathService) Div(ctx context.Context, in *model.MathRequest) (*model.MathResponse, error) {
	...
	if in == nil {
		return nil, fmt.Errorf("Div called with invaild parameter value nil")
	}
	if in.GetOperand2() == 0 {
...
func (m *myMathService) Mul(ctx context.Context, in *model.MathRequest) (*model.MathResponse, error) {
	...
	if in == nil {
		return nil, fmt.Errorf("Mul called with invaild parameter value nil")
	}
	if in.GetOperand2() == 0 {
		return nil, fmt.Errorf("Mul called with invalid paramter operand2 == 0")
	}
...
func (m *myMathService) Mod(ctx context.Context, in *model.MathRequest) (*model.MathResponse, error) {
	...
	if in == nil {
		return nil, fmt.Errorf("Mod called with invaild parameter value nil")
	}
